...
export default function ShoppingCartComponents({ detailsorder }: ShoppingCartItemsProps) {
    if (!detailsorder || detailsorder.length === 0) {
        return (
            <section className={CLASS_SECTION}>
                ...
                <button title='Continuar Comprando' type='button' className={CLASS_BUTTONS}>Continuar Comprando</button>
            </section>
        );
    };
    ...
    return (
        <section className={CLASS_SECTION}>
            ...
            {detailsorder.length > 1 && (<div className={CLASS_DIV_BUTTONS}>
                <button title='Continuar Comprando' type='button' className={CLASS_BUTTONS}>Continuar Comprando</button>
                <button title='Finalizar Pedido' type='button' className={CLASS_BUTTONS}>Finalizar Pedido</button>
            </div>
            )}
